        ...
        <div class="card mt-4 shadow">
            <div class="card-header">
                <h4 class="mb-0">Order View
                    <a href="orders-print.php?track=<?= $_GET['track']; ?>" class="btn btn-info mx-2 btn-sm float-end">Print</a>
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                <?php foreach($orderItemRes as $orderItemRow) : ?>
                                                                    <tr>
                                                                        <td>
                                                                            <img src="<?= $orderItemRow['image'] != '' ? '../'.$orderItemRow['image'] : '../assets/uploads/no-image.png'; ?>" alt="Img" 
