                    ...
                    if(isset($_GET['date']) || isset($_GET['payment_status'])){
                        ...
                        if($orderDate != '' && $paymentStatus == '')
                        {
                            $query = "SELECT o.*, c.* FROM orders o, customers c 
                                    WHERE c.id = o.customer_id AND o.order_date = '$orderDate' AND o.order_placed_by_id = '$user_id'  ORDER BY o.id DESC";

                        }elseif($orderDate == '' && $paymentStatus != ''){

                            $query = "SELECT o.*, c.* FROM orders o, customers c 
                                    WHERE c.id = o.customer_id AND o.payment_mode = '$paymentStatus' AND o.order_placed_by_id = '$user_id' ORDER BY o.id DESC";
                            ...
                            $query = "SELECT o.*, c.* FROM orders o, customers c 
                                    ...
                                    AND o.payment_mode = '$paymentStatus' AND o.order_placed_by_id = '$user_id' ORDER BY o.id DESC";
                        
                        }
                        else{

                            $query = "SELECT o.*, c.* FROM orders o, customers c 
                                    WHERE c.id = o.customer_id AND o.order_placed_by_id = '$user_id' ORDER BY o.id DESC";
